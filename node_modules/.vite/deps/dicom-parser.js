      ...
      return a = [function(e, t) {
        ...
        function n2(e2, t2) {
          if (2 <= e2.length) {
            ...
            if (t2 && (isNaN(r3) || void 0 !== a3 && isNaN(a3) || void 0 !== n3 && isNaN(n3) || void 0 !== i3 && isNaN(i3) || r3 < 0 || 23 < r3 || a3 && (a3 < 0 || 59 < a3) || n3 && (n3 < 0 || 59 < n3) || i3 && (i3 < 0 || 999999 < i3)))
        ...
        function l(n3, e2) {
          ...
          function a3(e3, t3) {
            for (var r4 = "", a4 = 0; a4 < e3; a4++)
              0 !== a4 && (r4 += "/"), r4 += t3.call(n3, i3, a4).toString();
            return r4;
          }
          if (true === d(r3))
            t2 = n3.string(i3);
        ...
        function u(e2, t2) {
          ...
          for (r3 in e2.elements) {
            ...
            if (true !== t2.omitPrivateAttibutes || !f(r3))
              if (n3.items) {
        ...
        function m(e2, t2, r3) {
          for (var a3, n3, i3 = r3; i3 < t2.fragments.length; i3++)
            if (a3 = e2, n3 = i3, n3 = t2.fragments[n3], !(!c(a3, n3.position + n3.length - 2) && !c(a3, n3.position + n3.length - 3)))
              return i3;
        }
        function p(e2, t2, r3) {
          if (void 0 === e2)
          ...
          if (true !== t2.encapsulatedPixelData)
          ...
          if (true !== t2.hadUndefinedLength)
            throw "dicomParser.createJPEGBasicOffsetTable: parameter 'pixelDataElement' refers to pixel data element that does not have encapsulated pixel data";
          if (void 0 === t2.basicOffsetTable)
            throw "dicomParser.createJPEGBasicOffsetTable: parameter 'pixelDataElement' refers to pixel data element that does not have encapsulated pixel data";
          if (void 0 === t2.fragments)
            throw "dicomParser.createJPEGBasicOffsetTable: parameter 'pixelDataElement' refers to pixel data element that does not have encapsulated pixel data";
          ...
          for (var a3 = [], n3 = 0; ; ) {
            ...
            var i3 = m(e2, t2, n3);
            if (void 0 === i3 || i3 === t2.fragments.length - 1)
              return a3;
            n3 = i3 + 1;
          }
        }
        ...
        function g(e2, t2, r3) {
          ...
          if (t2.encapsulatedPixelData = true, t2.basicOffsetTable = [], t2.fragments = [], "xfffee000" !== h(e2))
        ...
        function y(e2, t2) {
          ...
          for (var r3 = e2.byteArray.length - 8; e2.position <= r3; )
            if (65534 === e2.readUint16()) {
              var a3 = e2.readUint16();
              if (57565 === a3)
                return 0 !== e2.readUint32() && e2.warnings("encountered non zero length following item delimiter at position ".concat(e2.position - 4, " while reading element of undefined length with tag ").concat(t2.tag)), void (t2.length = e2.position - t2.dataOffset);
            }
        ...
        var w = function() {
          ...
          return e2 = a3, (t2 = [{ key: "uint16", value: function(e3, t3) {
            e3 = this.elements[e3];
            if (t3 = void 0 !== t3 ? t3 : 0, e3 && 0 !== e3.length)
        ...
        function q(e2, t2, r3) {
          ...
          if (r3 = void 0 === r3 ? t2.byteArray.length : r3, void 0 === t2)
        ...
        function T(e2, t2, r3) {
          var a3 = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : {};
          if (r3 = void 0 === r3 ? e2.byteArray.length : r3, void 0 === t2)
        ...
        function k(e2, t2) {
          if ("undefined" != typeof Buffer && e2 instanceof Buffer)
        ...
        var J = function() {
          function a3(e3, t3, r4) {
            ...
            if (t3 instanceof Uint8Array == false && ("undefined" == typeof Buffer || t3 instanceof Buffer == false))
          ...
          return function() {
            var e3 = function() {
              if (s2.getSize() <= 132 && o2)
                return false;
              if (s2.seek(128), "DICM" === s2.readFixedString(4))
                return true;
        ...
        function V(i3) {
          ...
          var e2, a3 = function(e3) {
            if (void 0 === e3.elements.x00020010)
        ...
        function _(e2, t2, r3, a3, n3) {
          if (n3 = n3 || t2.fragments, void 0 === e2)
        ...
        function W(e2, t2, r3, a3, n3) {
          if (a3 = a3 || t2.basicOffsetTable, n3 = n3 || t2.fragments, void 0 === e2)
        ...
        var $ = false;
        function K(e2, t2, r3) {
          if ($ || ($ = true, console && console.log && console.log("WARNING: dicomParser.readEncapsulatedPixelData() has been deprecated")), void 0 === e2)
        ...
        if (n.r(r2), Object.defineProperty(r2, "default", { enumerable: true, value: t }), 2 & e && "string" != typeof t)
          for (var a2 in t)
